export { UPClientProvider, UPClientProviderEvents, createClientUPProvider } from './client.js';
export { UPClientChannel, UPClientChannelEvents, UPProviderConnector, UPProviderConnectorEvents, UPProviderEndpoint, UPProviderEndpointEvents, createUPProviderConnector, getUPProviderChannel } from './server.js';
export { ModalPopup, createWalletPopup } from './popup.js';
 ...
 */
declare const arrayChanged: (_addresses1?: Array<`0x${string}` | string | null | undefined>, _addresses2?: Array<`0x${string}` | string | null | undefined>) => boolean;
/**
 ...
 */
declare const cleanupAccounts: (values: Array<`0x${string}` | undefined>) => `0x${string}`[];

export { arrayChanged, cleanupAccounts };
