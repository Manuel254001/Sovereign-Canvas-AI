...
var _UPClientProvider = class extends import_eventemitter3.default {
  constructor(options) {
    super();
...
var _UPClientChannel = class extends import_eventemitter32.default {
  ...
  emit(event, ...args) {
    if (__privateGet(this, _buffered2)) {
      __privateGet(this, _buffered2).push([event, args]);
      return false;
    }
    return super.emit(event, ...args);
  }
...
var _UPProviderConnector = class extends import_eventemitter32.default {
